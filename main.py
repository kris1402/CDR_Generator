...
label3 = tk.Label(frame, text = "You number: ", bg='#779EC6', font = '10')
label3.place(relx=0.03,rely=0.1, relheight=0.3, relwidth=0.22)

label4 = tk.Label(frame, text = "IMSI: ", bg='#779EC6', font = '10')
label4.place(relx=0.68,rely=0.1, relheight=0.3, relwidth=0.22, anchor = 'n')
#########################
button2 = tk.Button(frame1, text="Generate", font=40, command=lambda: create_csv())#create_csv())
